...
TICKETING_SERVICE_URL = os.environ.get("TICKETING_SERVICE_URL", "http://localhost:8002")
...
def mark_order_delivered(order_id: str) -> None:
    try:
        ...
        message = {"order_id": order_id, "status": "DELIVERED"}
        ...
        raise GraphQLError("Ticketing delivery update via RabbitMQ failed") from exc
